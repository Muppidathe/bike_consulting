...
if 'view_bills_result' not in st.session_state:
    st.session_state['view_bills_result']=[]
...
with st.form("fetch_details"):
    ...
    if fetch_submit:
        ...
        st.session_state.view_bills_result=result
## form 2
st.header("bills")
result=st.session_state.view_bills_result
if result:
    for i in result:
